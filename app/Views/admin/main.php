...
<!-- Navbar -->
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="image">
                <img src="/public/admin/adminlte/dist/img/cuong.png" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
                
                <a href="#" class="d-block">Cường</a>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="/admin/recruitment/add" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Thêm Tuyển Dụng</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/admin/recruitment/lists" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item">
                    ...
                    <i class="fas fa-spider"></i>
                        <p> Product Slider <i class="right fas fa-angle-left"></i> </p>
                    </a>
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="/admin/productslider/add" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Thêm Product Slider</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/admin/productslider/lists" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Danh Sách Product Slider</p>
                            </a>
                        </li>
    ...
    <script>CKEDITOR.replace( 'content' ); CKEDITOR.replace( 'content1' );</script>
