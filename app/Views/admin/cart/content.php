<div class="customer_info" style="margin-top: 15px;">
    <ul>
        <li>Tên khách Hàng: <strong><?=$data['customer']['name']?></strong></li>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                <th scope="row"><?=$i?></th>
                <td>
                    <a href="/san-pham/<?=$key?>/<?=Helper::slug($cart['name'])?>" target="_blank">
